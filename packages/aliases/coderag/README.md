...
**CodeRAG is now [repomap](https://github.com/SylphxAI/repomap)** — a map of your codebase for AI agents: code graph, hybrid search, call paths and change impact, with an interactive graph UI.
